package net.gama.ejempleos.controller;
...
import net.gama.ejempleos.service.ICategoriasService;
import net.gama.ejempleos.service.IVacantesService;
import net.gama.ejempleos.util.Utileria;
